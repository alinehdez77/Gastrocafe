...
CREATE TABLE [InsumosRecetas] (
    ...
    CONSTRAINT [FK_InsumosRecetas_Insumo_IdInsumo] FOREIGN KEY ([IdInsumo]) REFERENCES [Insumo] ([Id]) ON DELETE CASCADE,
...
VALUES (N'20200621005732_CrearTablas', N'2.0.3-rtm-10026');
